...
public class Namespace implements INamespace {
     ...
     */
    public final NamespaceValue PORTAL = new NamespaceValue(PORTAL_NAMESPACE_KEY, PORTAL_TALK, "Portal", "Appendix");
    ...
    public final NamespaceValue DRAFT = new NamespaceValue(DRAFT_NAMESPACE_KEY, DRAFT_TALK, "Draft", "Reconstruction");
    ...
    public final NamespaceValue THESAURUS_TALK = new NamespaceValue(THESAURUS_TALK_NAMESPACE_KEY, "Thesaurus_talk");
    public final NamespaceValue THESAURUS = new NamespaceValue(THESAURUS_NAMESPACE_KEY, THESAURUS_TALK, "Thesaurus");
    ...
    private void initializeNamespaces() {
        ...
        // Re-adds Wiktionary's aliases because extractFromResource() erases those definitions...
