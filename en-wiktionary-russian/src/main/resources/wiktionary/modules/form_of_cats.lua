...
cats["enm"] = {
	...
	{"hasall", {"13", "s", "past"}, "first/third-person singular past forms"},
	{"hasall", {"2", "s", "past"}, "second-person singular past forms"},
	{"hasall", {"p", "pres"},
		{"cond",
			{"has", "sub", "plural subjunctive forms"},
			{"has", "ind", "plural forms", "plural forms"},
		},
	},
	{"hasall", {"p", "past"},
		{"cond",
			{"has", "sub", "plural subjunctive past forms"},
			{"has", "ind", "plural past forms", "plural past forms"},
		},
	},
